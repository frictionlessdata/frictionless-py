...
# This code was taken from issue#837
def filter_dict(
    x: dict, include: list = None, exclude: list = None, order: list = None
) -> dict:
    """Filter and order dictionary by key names, #837"""
...
def dicts_to_markdown_table(dicts: List[dict], **kwargs) -> str:
    """Tabulate dictionaries and render as a Markdown table, #837"""
...
def json_to_markdown(
    ...
    """Render any JSON-like object as Markdown, using nested bulleted lists, #837"""
...
def render_markdown(path: str, data: dict) -> str:
    ...
    template_dir = os.path.join(os.path.dirname(__file__), "metadata/templates/markdown")
