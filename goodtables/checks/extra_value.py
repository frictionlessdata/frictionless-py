...
class ExtraValue(object):
    ...
    def check_row(self, cells):
        ...
        #should report extra value when cell does not have header and also has value in the cell
        cells_without_header = filter(lambda cell: cell.get('header') is None and cell.get('value'), cells)
