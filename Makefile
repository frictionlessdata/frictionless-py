...
install:
	pip install --upgrade -e .[aws,bigquery,ckan,dev,excel,json,github,gsheets,html,markdown,mysql,ods,pandas,parquet,postgresql,server,spss,sql,visidata,wkt,zenodo]
